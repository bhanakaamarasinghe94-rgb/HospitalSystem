...
int x=0;
  ...
  case 2:
    ...
    revenues[x] = finalAmount;
    discounts[x] = discount;
    specialties[x] = specialty;
    ages[x] = age;
    admissions[x] = isAdmitted;
    idAndDaysList[x][0] = idAndDays[0];
    idAndDaysList[x][1] = idAndDays[1];
    emeCharges[x] = emeCharge;
    wardCsts[x] = wardCst;
    grossTots[x] = grossTot;
    discounts[x] = discount;
    finalAmounts[x] = finalAmount;
    waitingTimes[x] = waitingTime;
     x++;
    break;
    ...
    case 4:
        bill(x,name,age,specialty,isAdmitted,idAndDays,level,emeCharge,wardCst,grossTot,discount,finalAmount,waitingTime);
        break;
    case 5:
        reports(names,levels,revenues,discounts,beds,x);
        int y;
        float highest;
        highest=revenues[0];
        for(y=1;y<x;y++)
